...
function SendIcon({ className }: { className?: string }) {
  return (
    <svg className={className} stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" aria-hidden>
...
export function ContactSection() {
  ...
  const submit = (e: FormEvent) => {
    ...
    const subject = `Portfolio message from ${n}`
    const body = `Name: ${n}\nEmail: ${em}\n\n${msg}\n`
  ...
  return (
    <section id="contact" className="scroll-mt-20 py-20" aria-labelledby="contact-heading">
      <Reveal>
        <div className="mb-16 text-center">
          <h2 id="contact-heading" className="mb-4 text-3xl font-bold text-[#143D95]">
            Get In Touch
          </h2>
      ...
      <div className="grid gap-12 md:grid-cols-2">
        <Reveal className="space-y-6">
          <div className="flex items-start space-x-4">
            <div className="mt-1 text-xl text-[#143D95]" aria-hidden>
              <svg stroke="currentColor" fill="currentColor" strokeWidth="0" className="h-5 w-5" viewBox="0 0 384 512">
          ...
          <div className="flex items-start space-x-4">
            <div className="mt-1 text-xl text-[#143D95]" aria-hidden>
              <svg stroke="currentColor" fill="currentColor" strokeWidth="0" className="h-5 w-5" viewBox="0 0 512 512">
        ...
        <Reveal delayMs={80}>
          <form className="space-y-6" onSubmit={submit}>
            ...
            <button
              type="submit"
              className="flex w-full items-center justify-center rounded-lg bg-[#143D95] px-6 py-3 font-medium text-white transition-colors hover:bg-primary-dark"
            >
